...
from project_paths import CLEAN_DATA_DIR
...
PROGRESS_FILE = CLEAN_DATA_DIR / "progress_movies_update.json"
...
async def main_async():
    ...
    """
    # Rutas de archivos
    input_file = CLEAN_DATA_DIR / "cleaned_movies.json"
    output_file = CLEAN_DATA_DIR / "enhanced_movies.json"
    backup_file = CLEAN_DATA_DIR / "enhanced_movies_backup.json"
...
def main_sequential():
    ...
    # Rutas de archivos
    input_file = CLEAN_DATA_DIR / "cleaned_movies.json"
    output_file = CLEAN_DATA_DIR / "enhanced_movies_sequential.json"
    backup_file = CLEAN_DATA_DIR / "enhanced_movies_backup_sequential.json"
...
async def test_main_async(limit: int):
    ...
    # Rutas de archivos
    input_file = CLEAN_DATA_DIR / "cleaned_movies.json"
    output_file = CLEAN_DATA_DIR / f"enhanced_movies_test_{limit}_parallel.json"
...
def test_main(limit: int):
    ...
    # Rutas de archivos
    input_file = CLEAN_DATA_DIR / "cleaned_movies.json"
    output_file = CLEAN_DATA_DIR / f"enhanced_movies_test_{limit}_sequential.json"
